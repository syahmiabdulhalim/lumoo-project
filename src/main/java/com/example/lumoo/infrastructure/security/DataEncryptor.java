...
public class DataEncryptor {
    ...
    // Prefix distinguishes encrypted values from existing plain-text rows in DB
    ...
    public String decrypt(String ciphertext) {
        ...
        // Backwards-compatible: plain-text rows (no prefix) are returned as-is
        ...
        try {
            ...
            // Decryption failed — value may be corrupted or plain text without prefix; return as-is
            return ciphertext;
        }
    }
}
