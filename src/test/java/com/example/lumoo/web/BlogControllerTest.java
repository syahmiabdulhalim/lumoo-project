...
class BlogControllerTest {
    ...
    void index_returns200() throws Exception {
        when(blogService.getPublishedPaged(anyInt(), anyInt())).thenReturn(new PageImpl<>(List.of()));
    ...
    void index_withPosts_setsFeatured() throws Exception {
        ...
        when(blogService.getPublishedPaged(anyInt(), anyInt())).thenReturn(new PageImpl<>(List.of(post)));
    ...
    void index_withCategory_returns200() throws Exception {
        when(blogService.getPublishedByCategoryPaged(eq("tips"), anyInt(), anyInt())).thenReturn(new PageImpl<>(List.of()));
