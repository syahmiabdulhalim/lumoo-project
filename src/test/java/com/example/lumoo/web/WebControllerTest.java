...
class WebControllerTest {
    ...
    void home_returns200() throws Exception {
        when(productService.getAllApproved(any())).thenReturn(new PageImpl<>(List.of()));
    ...
    void home_withKeyword_returns200() throws Exception {
        when(productService.searchApprovedPaged(eq("hat"), any())).thenReturn(new PageImpl<>(List.of()));
        when(blogService.getPublished()).thenReturn(List.of());
    ...
    void home_withCategory_returns200() throws Exception {
        when(productService.getApprovedByCategoryPaged(eq("Clothing"), any())).thenReturn(new PageImpl<>(List.of()));
        when(blogService.getPublished()).thenReturn(List.of());
    ...
    void store_returns200_whenVendorExists() throws Exception {
        ...
        when(productService.getApprovedByVendorPaged(any(User.class), any())).thenReturn(new PageImpl<>(List.of()));
        when(productService.getDistinctCategoriesByVendor(any(User.class))).thenReturn(List.of());
